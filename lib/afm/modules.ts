...
export const AFM_MODULES: AfmModule[] = [
  ...
  },
  {
    ...
    phase: 2,
    live: true,
    description: "Autonomous alarm, social, comment, content, and research agents.",
    features: ["Alarms", "Social posts", "Auto-comment", "Scheduling"],
  },
  {
    id: "memory",
    label: "Memory Engine",
  ...
  },
  {
    ...
    features: ["Next.js", "Prisma", "Export", "Live preview"],
  },
  {
    id: "business",
    ...
    phase: 3,
    live: true,
    description: "Plans, brand identity, website generation, and one-click deploy.",
