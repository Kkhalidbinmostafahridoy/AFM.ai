...
import { z } from "zod";
import { orchestrateChat, streamChat, getProvidersHealth, getConfiguredProviders, } from "@afm/ai-core";
    ...
    try {
        ...
        for await (const event of streamChat({
            ...
            if (event.type === "token") {
                ...
                res.write(`data: ${JSON.stringify({ type: "done", reply, meta: event.meta })}\n\n`);
            }
        }
        res.write("data: [DONE]\n\n");
        res.end();
